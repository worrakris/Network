 ...
 */
 ...
 $(document).ready(function(){
				...
				$(".<?=$classname?>").colorbox({inline:true, width:"50%"});
				$(".callbacks").colorbox({
...
<a class='<?=$classname?>' href="#<?=$divid?>"><?=$linklabel?></a>
  <div style='display:none'>
			<div id='<?=$divid?>' style='padding:10px; background:#fff;'>
			<?=$content?>
            <?php
			?>
		</div>
